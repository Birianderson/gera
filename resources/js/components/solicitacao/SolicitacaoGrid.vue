...
const columns = ref([
    ...
    },
    {
        ...
        formatter: (value, row) => {
            let output = "";
            output += `<a href="/mensagem_solicitacao/solicitacao/${value}" data-json='{"id": "${value}"}' data-tooltip="Editar" data-title="Atender Solicitação" class=" mx-1 action text-align-center"><i class="fa fa-comment"></i></a>`;
            return output;
        }
    }
]);
