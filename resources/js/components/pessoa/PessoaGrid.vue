...
const columns = ref([
    ...
    { name: 'cpf', title: 'CPF', width: '20%', nowrap: true },
    {
        name: 'estado_civil',
        title: 'Estado Civil',
        width: '20%',
    ...
    },
    {
        ...
        formatter: (value, row) => {
            let output = "";
            output += `<a href="javascript:;" data-json='{"id": "${value}"}' data-tooltip="Editar" data-action="popup" data-component="pessoa-form" data-title="Editar Pessoa" class=" mx-1 action text-align-center tooltip tooltip--top"><i class="fa fa-pencil"></i></a>`;
